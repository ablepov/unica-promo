      ...
      <div className="page-shell">
        <Reveal>
          <SectionHeading
            ...
            title="Модель поставки выбирается под вашу среду, а не под чужой шаблон."
            description="Cloud, on-prem и hybrid остаются частью одного интерфейса управления без раздвоения продукта."
          />
        </Reveal>
